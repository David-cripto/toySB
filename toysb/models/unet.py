        ...
        self.net = nn.Sequential(   
            ...
            SkipBlock([
                ...
                SkipBlock([
                    ...
                    SkipBlock([
                        nn.AvgPool2d(2),
                        ResConvBlock(c_inter * 4, c_inter * 8, c_inter * 8),
                        ResConvBlock(c_inter * 8, c_inter * 8, c_inter * 8),
                        ResConvBlock(c_inter * 8, c_inter * 8, c_inter * 8),
                        ResConvBlock(c_inter * 8, c_inter * 8, c_inter * 4),
                        nn.Upsample(scale_factor=2),
                    ]), 
                    ResConvBlock(c_inter * 8, c_inter * 4, c_inter * 4),
